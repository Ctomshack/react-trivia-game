...
const categories = [
    ...
    {name: 'Sports & Leisure', href: '/SportsAndLeisure', icon: 'MdSportsTennis'},
    ...
    {name: 'Society & Culture', href: '/SocietyAndCulture', icon: 'MdOutlineNaturePeople'},
    {name: 'Arts & Literature', href: '/ArtsAndLiterature', icon: 'IoBookSharp'},
]
