...
const calculateScore = (total) => {
  ...
  return (
    <div className="center-screen mx-8 flex flex-col justify-center align-middle bg-gray-700 py-16 px-8 lg:mx-28 my-6 rounded-md shadow-lg opacity-80">
        <div className="mb-12">
        <h1 className="text-5xl text-white font-bold mb-8 drop-shadow-md">You scored</h1>
        <h2 className="text-9xl text-orange-500 font-extrabold mb-8 drop-shadow-xl">{calculateScore(score)} %</h2>
        </div>
